...
std::string Tokenizer::try_consume_entity() {
    ...
    static const std::unordered_map<std::string, std::string> entities = {
        ...
        // === Category 1: Additional Latin Extended (U+0100-U+01AF, 176 entries) ===
        {"U0100", "\xC4\x80"},    // U+0100
        {"U0101", "\xC4\x81"},    // U+0101
        {"U0102", "\xC4\x82"},    // U+0102
        {"U0103", "\xC4\x83"},    // U+0103
        {"U0104", "\xC4\x84"},    // U+0104
        {"U0105", "\xC4\x85"},    // U+0105
        {"U0106", "\xC4\x86"},    // U+0106
        {"U0107", "\xC4\x87"},    // U+0107
        {"U0108", "\xC4\x88"},    // U+0108
        {"U0109", "\xC4\x89"},    // U+0109
        {"U010A", "\xC4\x8A"},    // U+010A
        {"U010B", "\xC4\x8B"},    // U+010B
        {"U010C", "\xC4\x8C"},    // U+010C
        {"U010D", "\xC4\x8D"},    // U+010D
        {"U010E", "\xC4\x8E"},    // U+010E
        {"U010F", "\xC4\x8F"},    // U+010F
        {"U0110", "\xC4\x90"},    // U+0110
        {"U0111", "\xC4\x91"},    // U+0111
        {"U0112", "\xC4\x92"},    // U+0112
        {"U0113", "\xC4\x93"},    // U+0113
        {"U0114", "\xC4\x94"},    // U+0114
        {"U0115", "\xC4\x95"},    // U+0115
        {"U0116", "\xC4\x96"},    // U+0116
        {"U0117", "\xC4\x97"},    // U+0117
        {"U0118", "\xC4\x98"},    // U+0118
        {"U0119", "\xC4\x99"},    // U+0119
        {"U011A", "\xC4\x9A"},    // U+011A
        {"U011B", "\xC4\x9B"},    // U+011B
        {"U011C", "\xC4\x9C"},    // U+011C
        {"U011D", "\xC4\x9D"},    // U+011D
        {"U011E", "\xC4\x9E"},    // U+011E
        {"U011F", "\xC4\x9F"},    // U+011F
        {"U0120", "\xC4\xA0"},    // U+0120
        {"U0121", "\xC4\xA1"},    // U+0121
        {"U0122", "\xC4\xA2"},    // U+0122
        {"U0123", "\xC4\xA3"},    // U+0123
        {"U0124", "\xC4\xA4"},    // U+0124
        {"U0125", "\xC4\xA5"},    // U+0125
        {"U0126", "\xC4\xA6"},    // U+0126
        {"U0127", "\xC4\xA7"},    // U+0127
        {"U0128", "\xC4\xA8"},    // U+0128
        {"U0129", "\xC4\xA9"},    // U+0129
        {"U012A", "\xC4\xAA"},    // U+012A
        {"U012B", "\xC4\xAB"},    // U+012B
        {"U012C", "\xC4\xAC"},    // U+012C
        {"U012D", "\xC4\xAD"},    // U+012D
        {"U012E", "\xC4\xAE"},    // U+012E
        {"U012F", "\xC4\xAF"},    // U+012F
        {"U0130", "\xC4\xB0"},    // U+0130
        {"U0131", "\xC4\xB1"},    // U+0131
        {"U0132", "\xC4\xB2"},    // U+0132
        {"U0133", "\xC4\xB3"},    // U+0133
        {"U0134", "\xC4\xB4"},    // U+0134
        {"U0135", "\xC4\xB5"},    // U+0135
        {"U0136", "\xC4\xB6"},    // U+0136
        {"U0137", "\xC4\xB7"},    // U+0137
        {"U0138", "\xC4\xB8"},    // U+0138
        {"U0139", "\xC4\xB9"},    // U+0139
        {"U013A", "\xC4\xBA"},    // U+013A
        {"U013B", "\xC4\xBB"},    // U+013B
        {"U013C", "\xC4\xBC"},    // U+013C
        {"U013D", "\xC4\xBD"},    // U+013D
        {"U013E", "\xC4\xBE"},    // U+013E
        {"U013F", "\xC4\xBF"},    // U+013F
        {"U0140", "\xC5\x80"},    // U+0140
        {"U0141", "\xC5\x81"},    // U+0141
        {"U0142", "\xC5\x82"},    // U+0142
        {"U0143", "\xC5\x83"},    // U+0143
        {"U0144", "\xC5\x84"},    // U+0144
        {"U0145", "\xC5\x85"},    // U+0145
        {"U0146", "\xC5\x86"},    // U+0146
        {"U0147", "\xC5\x87"},    // U+0147
        {"U0148", "\xC5\x88"},    // U+0148
        {"U0149", "\xC5\x89"},    // U+0149
        {"U014A", "\xC5\x8A"},    // U+014A
        {"U014B", "\xC5\x8B"},    // U+014B
        {"U014C", "\xC5\x8C"},    // U+014C
        {"U014D", "\xC5\x8D"},    // U+014D
        {"U014E", "\xC5\x8E"},    // U+014E
        {"U014F", "\xC5\x8F"},    // U+014F
        {"U0150", "\xC5\x90"},    // U+0150
        {"U0151", "\xC5\x91"},    // U+0151
        {"U0152", "\xC5\x92"},    // U+0152
        {"U0153", "\xC5\x93"},    // U+0153
        {"U0154", "\xC5\x94"},    // U+0154
        {"U0155", "\xC5\x95"},    // U+0155
        {"U0156", "\xC5\x96"},    // U+0156
        {"U0157", "\xC5\x97"},    // U+0157
        {"U0158", "\xC5\x98"},    // U+0158
        {"U0159", "\xC5\x99"},    // U+0159
        {"U015A", "\xC5\x9A"},    // U+015A
        {"U015B", "\xC5\x9B"},    // U+015B
        {"U015C", "\xC5\x9C"},    // U+015C
        {"U015D", "\xC5\x9D"},    // U+015D
        {"U015E", "\xC5\x9E"},    // U+015E
        {"U015F", "\xC5\x9F"},    // U+015F
        {"U0160", "\xC5\xA0"},    // U+0160
        {"U0161", "\xC5\xA1"},    // U+0161
        {"U0162", "\xC5\xA2"},    // U+0162
        {"U0163", "\xC5\xA3"},    // U+0163
        {"U0164", "\xC5\xA4"},    // U+0164
        {"U0165", "\xC5\xA5"},    // U+0165
        {"U0166", "\xC5\xA6"},    // U+0166
        {"U0167", "\xC5\xA7"},    // U+0167
        {"U0168", "\xC5\xA8"},    // U+0168
        {"U0169", "\xC5\xA9"},    // U+0169
        {"U016A", "\xC5\xAA"},    // U+016A
        {"U016B", "\xC5\xAB"},    // U+016B
        {"U016C", "\xC5\xAC"},    // U+016C
        {"U016D", "\xC5\xAD"},    // U+016D
        {"U016E", "\xC5\xAE"},    // U+016E
        {"U016F", "\xC5\xAF"},    // U+016F
        {"U0170", "\xC5\xB0"},    // U+0170
        {"U0171", "\xC5\xB1"},    // U+0171
        {"U0172", "\xC5\xB2"},    // U+0172
        {"U0173", "\xC5\xB3"},    // U+0173
        {"U0174", "\xC5\xB4"},    // U+0174
        {"U0175", "\xC5\xB5"},    // U+0175
        {"U0176", "\xC5\xB6"},    // U+0176
        {"U0177", "\xC5\xB7"},    // U+0177
        {"U0178", "\xC5\xB8"},    // U+0178
        {"U0179", "\xC5\xB9"},    // U+0179
        {"U017A", "\xC5\xBA"},    // U+017A
        {"U017B", "\xC5\xBB"},    // U+017B
        {"U017C", "\xC5\xBC"},    // U+017C
        {"U017D", "\xC5\xBD"},    // U+017D
        {"U017E", "\xC5\xBE"},    // U+017E
        {"U017F", "\xC5\xBF"},    // U+017F
        {"U0180", "\xC6\x80"},    // U+0180
        {"U0181", "\xC6\x81"},    // U+0181
        {"U0182", "\xC6\x82"},    // U+0182
        {"U0183", "\xC6\x83"},    // U+0183
        {"U0184", "\xC6\x84"},    // U+0184
        {"U0185", "\xC6\x85"},    // U+0185
        {"U0186", "\xC6\x86"},    // U+0186
        {"U0187", "\xC6\x87"},    // U+0187
        {"U0188", "\xC6\x88"},    // U+0188
        {"U0189", "\xC6\x89"},    // U+0189
        {"U018A", "\xC6\x8A"},    // U+018A
        {"U018B", "\xC6\x8B"},    // U+018B
        {"U018C", "\xC6\x8C"},    // U+018C
        {"U018D", "\xC6\x8D"},    // U+018D
        {"U018E", "\xC6\x8E"},    // U+018E
        {"U018F", "\xC6\x8F"},    // U+018F
        {"U0190", "\xC6\x90"},    // U+0190
        {"U0191", "\xC6\x91"},    // U+0191
        {"U0192", "\xC6\x92"},    // U+0192
        {"U0193", "\xC6\x93"},    // U+0193
        {"U0194", "\xC6\x94"},    // U+0194
        {"U0195", "\xC6\x95"},    // U+0195
        {"U0196", "\xC6\x96"},    // U+0196
        {"U0197", "\xC6\x97"},    // U+0197
        {"U0198", "\xC6\x98"},    // U+0198
        {"U0199", "\xC6\x99"},    // U+0199
        {"U019A", "\xC6\x9A"},    // U+019A
        {"U019B", "\xC6\x9B"},    // U+019B
        {"U019C", "\xC6\x9C"},    // U+019C
        {"U019D", "\xC6\x9D"},    // U+019D
        {"U019E", "\xC6\x9E"},    // U+019E
        {"U019F", "\xC6\x9F"},    // U+019F
        {"U01A0", "\xC6\xA0"},    // U+01A0
        {"U01A1", "\xC6\xA1"},    // U+01A1
        {"U01A2", "\xC6\xA2"},    // U+01A2
        {"U01A3", "\xC6\xA3"},    // U+01A3
        {"U01A4", "\xC6\xA4"},    // U+01A4
        {"U01A5", "\xC6\xA5"},    // U+01A5
        {"U01A6", "\xC6\xA6"},    // U+01A6
        {"U01A7", "\xC6\xA7"},    // U+01A7
        {"U01A8", "\xC6\xA8"},    // U+01A8
        {"U01A9", "\xC6\xA9"},    // U+01A9
        {"U01AA", "\xC6\xAA"},    // U+01AA
        {"U01AB", "\xC6\xAB"},    // U+01AB
        {"U01AC", "\xC6\xAC"},    // U+01AC
        {"U01AD", "\xC6\xAD"},    // U+01AD
        {"U01AE", "\xC6\xAE"},    // U+01AE
        {"U01AF", "\xC6\xAF"},    // U+01AF

        // === Category 2: Combining Diacritical Marks (U+0300-U+0317, 24 entries) ===
        {"combining_grave", "\xCC\x80"},    // U+0300
        {"combining_acute", "\xCC\x81"},    // U+0301
        {"combining_circumflex", "\xCC\x82"},    // U+0302
        {"combining_tilde", "\xCC\x83"},    // U+0303
        {"combining_macron", "\xCC\x84"},    // U+0304
        {"combining_overline", "\xCC\x85"},    // U+0305
        {"combining_breve", "\xCC\x86"},    // U+0306
        {"combining_dot_above", "\xCC\x87"},    // U+0307
        {"combining_diaeresis", "\xCC\x88"},    // U+0308
        {"combining_hook_above", "\xCC\x89"},    // U+0309
        {"combining_ring_above", "\xCC\x8A"},    // U+030A
        {"combining_double_acute", "\xCC\x8B"},    // U+030B
        {"combining_caron", "\xCC\x8C"},    // U+030C
        {"combining_vertical_line_above", "\xCC\x8D"},    // U+030D
        {"combining_double_vertical_line_above", "\xCC\x8E"},    // U+030E
        {"combining_double_grave", "\xCC\x8F"},    // U+030F
        {"combining_candrabindu", "\xCC\x90"},    // U+0310
        {"combining_inverted_breve", "\xCC\x91"},    // U+0311
        {"combining_turned_comma_above", "\xCC\x92"},    // U+0312
        {"combining_comma_above", "\xCC\x93"},    // U+0313
        {"combining_reversed_comma_above", "\xCC\x94"},    // U+0314
        {"combining_comma_above_right", "\xCC\x95"},    // U+0315
        {"combining_grave_below", "\xCC\x96"},    // U+0316
        {"combining_acute_below", "\xCC\x97"},    // U+0317

        // === Category 3: Spacing Modifiers (U+02B0-U+02BF, 16 entries) ===
        {"modifier_B0", "\xCA\xB0"},    // U+02B0
        {"modifier_B1", "\xCA\xB1"},    // U+02B1
        {"modifier_B2", "\xCA\xB2"},    // U+02B2
        {"modifier_B3", "\xCA\xB3"},    // U+02B3
        {"modifier_B4", "\xCA\xB4"},    // U+02B4
        {"modifier_B5", "\xCA\xB5"},    // U+02B5
        {"modifier_B6", "\xCA\xB6"},    // U+02B6
        {"modifier_B7", "\xCA\xB7"},    // U+02B7
        {"modifier_B8", "\xCA\xB8"},    // U+02B8
        {"modifier_B9", "\xCA\xB9"},    // U+02B9
        {"modifier_BA", "\xCA\xBA"},    // U+02BA
        {"modifier_BB", "\xCA\xBB"},    // U+02BB
        {"modifier_BC", "\xCA\xBC"},    // U+02BC
        {"modifier_BD", "\xCA\xBD"},    // U+02BD
        {"modifier_BE", "\xCA\xBE"},    // U+02BE
        {"modifier_BF", "\xCA\xBF"},    // U+02BF

        // === Category 4: Mathematical Operators (U+2A00-U+2A1D, 30 entries) ===
        {"U2A00", "\xE2\xA8\x80"},    // U+2A00
        {"U2A01", "\xE2\xA8\x81"},    // U+2A01
        {"U2A02", "\xE2\xA8\x82"},    // U+2A02
        {"U2A03", "\xE2\xA8\x83"},    // U+2A03
        {"U2A04", "\xE2\xA8\x84"},    // U+2A04
        {"U2A05", "\xE2\xA8\x85"},    // U+2A05
        {"U2A06", "\xE2\xA8\x86"},    // U+2A06
        {"U2A07", "\xE2\xA8\x87"},    // U+2A07
        {"U2A08", "\xE2\xA8\x88"},    // U+2A08
        {"U2A09", "\xE2\xA8\x89"},    // U+2A09
        {"U2A0A", "\xE2\xA8\x8A"},    // U+2A0A
        {"U2A0B", "\xE2\xA8\x8B"},    // U+2A0B
        {"U2A0C", "\xE2\xA8\x8C"},    // U+2A0C
        {"U2A0D", "\xE2\xA8\x8D"},    // U+2A0D
        {"U2A0E", "\xE2\xA8\x8E"},    // U+2A0E
        {"U2A0F", "\xE2\xA8\x8F"},    // U+2A0F
        {"U2A10", "\xE2\xA8\x90"},    // U+2A10
        {"U2A11", "\xE2\xA8\x91"},    // U+2A11
        {"U2A12", "\xE2\xA8\x92"},    // U+2A12
        {"U2A13", "\xE2\xA8\x93"},    // U+2A13
        {"U2A14", "\xE2\xA8\x94"},    // U+2A14
        {"U2A15", "\xE2\xA8\x95"},    // U+2A15
        {"U2A16", "\xE2\xA8\x96"},    // U+2A16
        {"U2A17", "\xE2\xA8\x97"},    // U+2A17
        {"U2A18", "\xE2\xA8\x98"},    // U+2A18
        {"U2A19", "\xE2\xA8\x99"},    // U+2A19
        {"U2A1A", "\xE2\xA8\x9A"},    // U+2A1A
        {"U2A1B", "\xE2\xA8\x9B"},    // U+2A1B
        {"U2A1C", "\xE2\xA8\x9C"},    // U+2A1C
        {"U2A1D", "\xE2\xA8\x9D"},    // U+2A1D

        // === Category 5: Arrows (U+2190-U+21AD, 30 entries) ===
        {"arrow_2190", "\xE2\x86\x90"},    // U+2190
        {"arrow_2191", "\xE2\x86\x91"},    // U+2191
        {"arrow_2192", "\xE2\x86\x92"},    // U+2192
        {"arrow_2193", "\xE2\x86\x93"},    // U+2193
        {"arrow_2194", "\xE2\x86\x94"},    // U+2194
        {"arrow_2195", "\xE2\x86\x95"},    // U+2195
        {"arrow_2196", "\xE2\x86\x96"},    // U+2196
        {"arrow_2197", "\xE2\x86\x97"},    // U+2197
        {"arrow_2198", "\xE2\x86\x98"},    // U+2198
        {"arrow_2199", "\xE2\x86\x99"},    // U+2199
        {"arrow_219A", "\xE2\x86\x9A"},    // U+219A
        {"arrow_219B", "\xE2\x86\x9B"},    // U+219B
        {"arrow_219C", "\xE2\x86\x9C"},    // U+219C
        {"arrow_219D", "\xE2\x86\x9D"},    // U+219D
        {"arrow_219E", "\xE2\x86\x9E"},    // U+219E
        {"arrow_219F", "\xE2\x86\x9F"},    // U+219F
        {"arrow_21A0", "\xE2\x86\xA0"},    // U+21A0
        {"arrow_21A1", "\xE2\x86\xA1"},    // U+21A1
        {"arrow_21A2", "\xE2\x86\xA2"},    // U+21A2
        {"arrow_21A3", "\xE2\x86\xA3"},    // U+21A3
        {"arrow_21A4", "\xE2\x86\xA4"},    // U+21A4
        {"arrow_21A5", "\xE2\x86\xA5"},    // U+21A5
        {"arrow_21A6", "\xE2\x86\xA6"},    // U+21A6
        {"arrow_21A7", "\xE2\x86\xA7"},    // U+21A7
        {"arrow_21A8", "\xE2\x86\xA8"},    // U+21A8
        {"arrow_21A9", "\xE2\x86\xA9"},    // U+21A9
        {"arrow_21AA", "\xE2\x86\xAA"},    // U+21AA
        {"arrow_21AB", "\xE2\x86\xAB"},    // U+21AB
        {"arrow_21AC", "\xE2\x86\xAC"},    // U+21AC
        {"arrow_21AD", "\xE2\x86\xAD"},    // U+21AD

        // === Category 6: Geometric Shapes (U+25A0-U+25BF, 32 entries) ===
        {"shape_25A0", "\xE2\x96\xA0"},    // U+25A0
        {"shape_25A1", "\xE2\x96\xA1"},    // U+25A1
        {"shape_25A2", "\xE2\x96\xA2"},    // U+25A2
        {"shape_25A3", "\xE2\x96\xA3"},    // U+25A3
        {"shape_25A4", "\xE2\x96\xA4"},    // U+25A4
        {"shape_25A5", "\xE2\x96\xA5"},    // U+25A5
        {"shape_25A6", "\xE2\x96\xA6"},    // U+25A6
        {"shape_25A7", "\xE2\x96\xA7"},    // U+25A7
        {"shape_25A8", "\xE2\x96\xA8"},    // U+25A8
        {"shape_25A9", "\xE2\x96\xA9"},    // U+25A9
        {"shape_25AA", "\xE2\x96\xAA"},    // U+25AA
        {"shape_25AB", "\xE2\x96\xAB"},    // U+25AB
        {"shape_25AC", "\xE2\x96\xAC"},    // U+25AC
        {"shape_25AD", "\xE2\x96\xAD"},    // U+25AD
        {"shape_25AE", "\xE2\x96\xAE"},    // U+25AE
        {"shape_25AF", "\xE2\x96\xAF"},    // U+25AF
        {"shape_25B0", "\xE2\x96\xB0"},    // U+25B0
        {"shape_25B1", "\xE2\x96\xB1"},    // U+25B1
        {"shape_25B2", "\xE2\x96\xB2"},    // U+25B2
        {"shape_25B3", "\xE2\x96\xB3"},    // U+25B3
        {"shape_25B4", "\xE2\x96\xB4"},    // U+25B4
        {"shape_25B5", "\xE2\x96\xB5"},    // U+25B5
        {"shape_25B6", "\xE2\x96\xB6"},    // U+25B6
        {"shape_25B7", "\xE2\x96\xB7"},    // U+25B7
        {"shape_25B8", "\xE2\x96\xB8"},    // U+25B8
        {"shape_25B9", "\xE2\x96\xB9"},    // U+25B9
        {"shape_25BA", "\xE2\x96\xBA"},    // U+25BA
        {"shape_25BB", "\xE2\x96\xBB"},    // U+25BB
        {"shape_25BC", "\xE2\x96\xBC"},    // U+25BC
        {"shape_25BD", "\xE2\x96\xBD"},    // U+25BD
        {"shape_25BE", "\xE2\x96\xBE"},    // U+25BE
        {"shape_25BF", "\xE2\x96\xBF"},    // U+25BF
