...
// =========================================================================
// window.scrollTo / window.scrollBy / window.scroll -- no-ops
// =========================================================================

static JSValue js_window_scroll_noop(JSContext* /*ctx*/, JSValueConst /*this_val*/,
                                      int /*argc*/, JSValueConst* /*argv*/) {
    return JS_UNDEFINED;
}
...
(function(loc) {
    ...
    JS_SetPropertyStr(ctx, global, "scrollTo",
        JS_NewCFunction(ctx, js_window_scroll_noop, "scrollTo", 2));
    JS_SetPropertyStr(ctx, global, "scrollBy",
        JS_NewCFunction(ctx, js_window_scroll_noop, "scrollBy", 2));
    JS_SetPropertyStr(ctx, global, "scroll",
        JS_NewCFunction(ctx, js_window_scroll_noop, "scroll", 2));
